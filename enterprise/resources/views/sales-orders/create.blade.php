    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('sales-orders.store') }}" id="so-form">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="customer_id" id="customer_id" class="form-control" required>
                                <option value="">Select Customer</option>
                                @foreach($customers as $customer)
                                <option value="{{ $customer->id }}" @if(old('customer_id') == $customer->id) selected @endif>{{ $customer->name }} ({{ $customer->customer_code }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <button type="button" class="btn btn-secondary btn-sm mb-3" id="add-so-item-btn">+ Add Line</button>
